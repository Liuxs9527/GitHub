 ...
 * 文件描述：
 * 作者：${郭少堋}
 * 创建时间：2019/2/15   19:46
 * 更改时间：2019/2/15   19:46
 * 版本号：1
 */
public class Tjactivity extends Fragment implements Logincontract.Loginview {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.tj, null);
        ...
        grideadapter = new Grideadapter(R.layout.tj_text, pzsh);
        //给组件id
    ...
    public void shapeData(Shoppingbean shoppingbean) {
        ...
        //设置适配器
        Grideadapter grideadapter = new Grideadapter(R.layout.tj_text, data);
